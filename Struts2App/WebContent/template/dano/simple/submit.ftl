...
<#include "/${parameters.templateDir}/${parameters.theme}/simple/scripting-events.ftl"/>
<#include "/${parameters.templateDir}/${parameters.theme}/simple/common-attributes.ftl" />
